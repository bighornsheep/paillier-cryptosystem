 ...
 * @brief  - Measures runtimes of the Paillier cryptosystem (basic) and writes the timing information to files
 */
...
int main(int argc, char** argv) {
    ...
    snprintf(t_file, PATH_MAX, "output/crc_%s_%s.txt", argv[2], argv[1]);
